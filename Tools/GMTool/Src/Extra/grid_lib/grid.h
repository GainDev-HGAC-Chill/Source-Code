...
public:
	...
	void					Draw(HDC hdc, DWORD dwTick);
...
#ifdef PG_USE_CONST
	void					SetCellConst(CellID id, const bool e);
	bool					GetCellConst(CellID id);
#endif
