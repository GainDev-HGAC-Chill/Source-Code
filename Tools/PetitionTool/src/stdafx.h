...
#define STRING_TABLE_COMMON			10000
#define MSG_CREATE_CHAT				1
#define MSG_RECV_USER_CHAT			2
#define MSG_DISCONNECTED_SERVER		3
#define MSG_PETITION_REFLASH		4
#define MSG_DESTROY_CHATDLG			5
