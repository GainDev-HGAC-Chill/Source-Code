namespace Emergent.Gamebryo.SceneDesigner.GUI.ProjectG
{
	partial class FogPanel
	{
		...
		private void InitializeComponent()
		{
			...
			this.m_btnFogColor.Text = "Fog Color"; // this.m_btnFogColor.Text = "안개 색상";
			...
			this.label1.Text = "Start"; // this.label1.Text = "근단면";
			// 
			// label2
			// 
			...
			this.label2.Text = "End"; // this.label2.Text = "원단면";
			// 
			// label3
			// 
			...
			this.label3.Text = "Density"; // this.label3.Text = "강   도";
			// 
			// m_cbFogOnOff
			// 
			...
			this.label4.Text = "Fog On"; // this.label4.Text = "안개켜기";
			// 
			// m_rbZLinear
			// 
			...
			this.groupBox1.Text = "Fog Type"; // this.groupBox1.Text = "안개 형식";
			// 
			// m_rbRangeRQ
			// 
			...
			this.label5.Text = "Results"; // this.label5.Text = "결   과";
			// 
			// m_btnApplyFog
			// 
			...
			this.m_btnApplyFog.Text = "Apply Fog"; /// this.m_btnApplyFog.Text = "포그 적용";
