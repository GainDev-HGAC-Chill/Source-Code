namespace Emergent.Gamebryo.SceneDesigner.GUI.ProjectG
{
	partial class PathPanel
	{
		...
		private void InitializeComponent()
		{
			...
			this.m_btnDraw.Text = "Draw"; // this.m_btnDraw.Text = "그리기";
			...
			this.m_btnMakeUp.Text = "Upload"; // this.m_btnMakeUp.Text = "올리기";
			...
			this.m_btnClear.Text = "Clear"; // this.m_btnClear.Text = "모두 삭제";
			...
			this.m_btnMakeWall.Text = "Make Wall"; // this.m_btnMakeWall.Text = "만들기";
			...
			this.label2.Text = "Length"; // this.label2.Text = "길이";
			// 
			// m_tbMeshGroup
			// 
			...
			this.label19.Text = "Mesh Group"; // this.label19.Text = "메시 그룹";
			// 
			// m_btnMakeSide
			// 
			...
			this.m_btnMakeSide.Text = "Sideways"; // this.m_btnMakeSide.Text = "옆으로";
			...
			this.m_btnExtract.Text = "Point Extraction"; // this.m_btnExtract.Text = "점 추출";
			...
			this.label1.Text = "Group 3 is for monsters only"; // this.label1.Text = "3번 그룹은 몬스터전용";
			// 
			...
			this.m_btnExtractPathNumber.Text = "Add a path"; // this.m_btnExtractPathNumber.Text = "패스 추가";
			...
			this.m_btnCancelMakeup.Text = "Cancel Makeup"; // this.m_btnCancelMakeup.Text = "올리기/옆으로 취소";
			...
			this.m_btnMakeStraight.Text = "Make Straight"; // this.m_btnMakeStraight.Text = "직선화";
			...
			this.label4.Text = "Path Direction"; // this.label4.Text = "패스 방향";
			// 
			// label3
			// 
			...
			this.label3.Text = "Path Type"; // this.label3.Text = "패스 타입";
			// 
			// groupBox2
			// 
			...
			this.label5.Text = "Adjuster Size"; // this.label5.Text = "조절자크기";
			// 
			// m_trbAnchorScale
			// 
			...
			this.m_btnCancelMakeStraight.Text = "Cancel Make Straight"; // this.m_btnCancelMakeStraight.Text = "직선화 취소"; 
