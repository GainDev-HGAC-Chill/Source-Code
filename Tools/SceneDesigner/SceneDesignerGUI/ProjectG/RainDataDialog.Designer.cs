namespace Emergent.Gamebryo.SceneDesigner.GUI.ProjectG
{
	partial class RainDataDialog
	{
		...
		private void InitializeComponent()
		{
			...
			this.m_btnOK.Text = "Ok"; // this.m_btnOK.Text = "확인";
			...
			this.m_btnCancel.Text = "Cancel"; // this.m_btnCancel.Text = "취소";
			...
			this.label1.Text = "File"; // this.label1.Text = "파일";
			// 
			// label2
			// 
			...
			this.label2.Text = "Intrinsic Value (range: 0.0 ~ 1.0)"; // this.label2.Text = "내적 값 (범위 0.0 ~ 1.0)";
			// 
			// m_lblAngle
			// 
			...
			this.m_lblAngle.Text = "Angle: 0˚"; // this.m_lblAngle.Text = "각도: 0˚";
			// 
			// m_lbIgnoreList
			// 
			...
			this.label3.Text = "Nodes to omit."; // this.label3.Text = "생략할 노드들.";
			// 
			// m_btnIgnoreAdd
			// 
			...
			this.m_btnIgnoreAdd.Text = "Add"; // this.m_btnIgnoreAdd.Text = "추가";
			...
			this.m_btnIgnoreModify.Text = "Change"; // this.m_btnIgnoreModify.Text = "변경";
			...
			this.m_btnIgnoreDelete.Text = "Delete"; // this.m_btnIgnoreDelete.Text = "삭제";
			...
			this.m_rbBinary.Text = "Binary Output"; // this.m_rbBinary.Text = "이진 출력"; 
			...
			this.m_rbText.Text = "Text Output"; // this.m_rbText.Text = "텍스트 출력";
