namespace Emergent.Gamebryo.SceneDesigner.GUI.ProjectG
{
	partial class ZoneControl
	{
		...
		private void InitializeComponent()
		{
			...
			this.m_cbActivateZoneControl.Text = "Zone Control Activation"; // this.m_cbActivateZoneControl.Text = "Zone Control 활성화";
			...
			this.m_cbPlayerBase.Text = "Zone view by player"; // this.m_cbPlayerBase.Text = "플레이어 기준으로 Zone 보기";
			...
			this.m_btnComputeBound.Text = "World Bound Calculation"; // this.m_btnComputeBound.Text = "World Bound 계산";
