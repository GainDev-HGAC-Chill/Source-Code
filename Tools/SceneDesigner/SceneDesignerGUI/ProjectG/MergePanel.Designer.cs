...
namespace Emergent.Gamebryo.SceneDesigner.GUI.ProjectG
{
	partial class MergePanel
	{
		...
		private void InitializeComponent()
		{
			...
			m_cbGetByNewSelectionSet.Text = "Import as a new set; // m_cbGetByNewSelectionSet.Text = "새 Set으로 가져오기";
			...
			this.m_btnMerge.Text = "Import"; // this.m_btnMerge.Text = "가져오기";
			...
			this.m_btnCancel.Text = "Cancel"; // this.m_btnCancel.Text = "취   소";
			...
			this.m_tbNewSelectionSet.Text = "New Set Name"; // this.m_tbNewSelectionSet.Text = "새 Set 이름"; 
			// 
			// MergePanel
			// 
