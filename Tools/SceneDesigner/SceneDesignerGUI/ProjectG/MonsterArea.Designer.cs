namespace Emergent.Gamebryo.SceneDesigner.GUI.ProjectG
{
	partial class MonsterArea
	{
		...
		private void InitializeComponent()
		{
			...
			this.m_btnExtractPoint.Text = "Extract Point"; // this.m_btnExtractPoint.Text = "점추출";
			...
			this.m_btnErasePoint.Text = "Remove Point"; // this.m_btnErasePoint.Text = "점제거";
			...
			this.m_btnMakeCircle.Text = "Make Circle"; // this.m_btnMakeCircle.Text = "원 만들기";
			...
			this.m_btnMake.Text = "Make Square"; // this.m_btnMake.Text = "사각 만들기";
			...
			this.m_btnRevert.Text = "Revert"; // this.m_btnRevert.Text = "뒤집기";
			...
			this.m_btnMakeDot.Text = "Make Dot"; // this.m_btnMakeDot.Text = "점찍기";
