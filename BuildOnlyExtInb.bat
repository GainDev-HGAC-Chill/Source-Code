...
SET LOGFILE="BuildOnlyExtInb.log"
SET SOURCE_EXE="..\Dragonica_Exe\SFreedom_Dev\Release\Dragonica_INB.exe"
SET SOURCE_MAP="..\Dragonica_Exe\SFreedom_Dev\Release\Dragonica_INB.map"
SET SOURCE_PDB="..\Dragonica_Exe\SFreedom_Dev\Release\Dragonica_INB.pdb"
SET SOURCE_ZIP="..\Dragonica_Exe\SFreedom_Dev\Release\Dragonica_INB.zip"
...
%MSDEV% /rebuild Dragonica_INB .\Freedom\MobileSuit\Freedom.sln >> %LOGFILE%
