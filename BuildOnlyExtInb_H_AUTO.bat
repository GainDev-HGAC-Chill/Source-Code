...
SET LOGFILE="BuildOnlyExtInb_H_AUTO.log"
SET SOURCE_EXE="..\Dragonica_Exe\SFreedom_Dev\Release\Dragonica_INB_H_AUTO.exe"
SET SOURCE_MAP="..\Dragonica_Exe\SFreedom_Dev\Release\Dragonica_INB_H_AUTO.map"
SET SOURCE_PDB="..\Dragonica_Exe\SFreedom_Dev\Release\Dragonica_INB_H_AUTO.pdb"
SET SOURCE_ZIP="..\Dragonica_Exe\SFreedom_Dev\Release\Dragonica_INB_H_AUTO.zip"
...
%MSDEV% /rebuild Dragonica_INB_H_AUTO .\Freedom\MobileSuit\Freedom.sln >> %LOGFILE%
