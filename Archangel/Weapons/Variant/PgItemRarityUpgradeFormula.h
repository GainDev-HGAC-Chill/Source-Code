...
// 인첸트 필요 재료 계산 함수들
	...
	//New function with item level restriction
	static bool GetMaxGradeLevelRestrict(E_ITEM_GRADE const kItemGrade, bool const bIsPet, int& iOutLevel, PgBase_Item const& kItem);
...
// 소울크래프트 옵션 증폭 필요 재료 계산 함수들
	...
	//bool GetMaxGradeLevel(E_ITEM_GRADE const kItemGrade, bool const bIsPet, int& iOutLevel);
