...
typedef enum : __int64 {
	...
	UCLIMIT_COMMON_KNIGHT = UCLIMIT_KNIGHT | UCLIMIT_PALADIN | UCLIMIT_DRAOON,
	UCLIMIT_COMMON_WARRIOR = UCLIMIT_WARRIOR | UCLIMIT_GLADIATOR | UCLIMIT_DESTROYER,
	UCLIMIT_COMMON_MAGE = UCLIMIT_MAGE | UCLIMIT_WIZARD | UCLIMIT_ARCHMAGE,
	UCLIMIT_COMMON_BATTLEMAGE = UCLIMIT_BATTELMAGE | UCLIMIT_WARMAGE | UCLIMIT_WARLORD,
	UCLIMIT_COMMON_HUNTER = UCLIMIT_HUNTER | UCLIMIT_TRAPPER | UCLIMIT_SENTINEL,
	UCLIMIT_COMMON_RANGER = UCLIMIT_RANGER | UCLIMIT_SNIPER | UCLIMIT_LAUNCHER,
	UCLIMIT_COMMON_CLOWN = UCLIMIT_CLOWN | UCLIMIT_DANCER | UCLIMIT_MANIAC,
	UCLIMIT_COMMON_ASSASSIN = UCLIMIT_ASSASSIN | UCLIMIT_NINJA | UCLIMIT_SHADOW,


	UCLIMIT_COMMON_SHAMAN = UCLIMIT_SHAMAN | UCLIMIT_SUMMONER | UCLIMIT_BEAST_MASTER | UCLIMIT_GAIA_MASTER,

	UCLIMIT_COMMON_DOUBLE_FIGHTER = UCLIMIT_DOUBLE_FIGHTER | UCLIMIT_TWINS | UCLIMIT_MIRAGE | UCLIMIT_DRAGON_FIGHTER,
	
	// Market SearchKey
	UCLIMIT_MARKET_FIGHTER = UCLIMIT_FIGHTER | UCLIMIT_KNIGHT | UCLIMIT_WARRIOR | UCLIMIT_PALADIN | UCLIMIT_GLADIATOR | UCLIMIT_DRAOON | UCLIMIT_DESTROYER | UCLIMIT_DRAOON | UCLIMIT_DESTROYER,
	UCLIMIT_MARKET_MAGICIAN = UCLIMIT_MAGICIAN | UCLIMIT_MAGE | UCLIMIT_BATTELMAGE | UCLIMIT_WIZARD | UCLIMIT_WARMAGE | UCLIMIT_ARCHMAGE | UCLIMIT_WARLORD | UCLIMIT_ARCHMAGE | UCLIMIT_WARLORD,
	UCLIMIT_MARKET_ARCHER = UCLIMIT_ARCHER | UCLIMIT_HUNTER | UCLIMIT_RANGER | UCLIMIT_TRAPPER | UCLIMIT_SNIPER | UCLIMIT_SENTINEL | UCLIMIT_LAUNCHER | UCLIMIT_SENTINEL | UCLIMIT_LAUNCHER,
	UCLIMIT_MARKET_THIEF = UCLIMIT_THIEF | UCLIMIT_CLOWN | UCLIMIT_ASSASSIN | UCLIMIT_DANCER | UCLIMIT_NINJA | UCLIMIT_MANIAC | UCLIMIT_SHADOW | UCLIMIT_MANIAC | UCLIMIT_SHADOW,
	
	UCLIMIT_MARKET_SHAMAN = UCLIMIT_SHAMAN | UCLIMIT_SUMMONER | UCLIMIT_BEAST_MASTER | UCLIMIT_GAIA_MASTER,
	UCLIMIT_MARKET_DOUBLE_FIGHTER = UCLIMIT_DOUBLE_FIGHTER | UCLIMIT_TWINS | UCLIMIT_MIRAGE | UCLIMIT_DRAGON_FIGHTER,
