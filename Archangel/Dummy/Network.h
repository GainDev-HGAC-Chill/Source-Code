...
public:
	...
	bool SendToSwitch(const CEL::SESSION_KEY &rkSessionKey, const BM::CPacket &rkPacket);
	bool SendToLogin(const CEL::SESSION_KEY &rkSessionKey, const BM::CPacket &rkPacket);
...
protected:
	...
	static void CALLBACK OnRecvFromLogin( CEL::CSession_Base *pSession, BM::CPacket * const pPacket );
	...
	static void CALLBACK OnRecvFromSwitch( CEL::CSession_Base *pSession, BM::CPacket * const pPacket );
...
protected:
	...
	static void CALLBACK OnRecvFromX( CEL::CSession_Base *pSession, BM::CPacket * const pPacket );
public:
