...
public:
	virtual HRESULT ProcessPacket( BM::CPacket::DEF_PACKET_TYPE const kType, BM::CPacket &rkPacket ) = 0;
	virtual void Update(){}
...
inline bool PgAPServer_Base::Send( BM::CPacket const &kPacket )const
{
	using namespace CEL;
...
public:
	...
	HRESULT Locked_ProcessPacket( BM::GUID const &kSessionID, BM::CPacket::DEF_PACKET_TYPE const kType, BM::CPacket &rkPacket )const;
