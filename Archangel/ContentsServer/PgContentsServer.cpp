...
//	int iValue = 134217727;
	...
	/*g_kCheckMacAddress.SetMacAddress( (LOCAL_MGR::NATION_CODE)g_kLocal.ServiceRegion() );
	if( !g_kCheckMacAddress.CheckMacAddress() )
	{
		return 0; // 일부러 로그 남기지 않는다.
	}*/
