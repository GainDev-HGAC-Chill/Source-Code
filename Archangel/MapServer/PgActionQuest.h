...
{
public:
	explicit PgAction_MonsterQuestCheck(int const iCurGroundNo, SGroundKey const &rkGndKey, unsigned int iCombo, int const iMissionKey, int const iMissionLevel, int const iMssionStageCount);
...
{
public:
	explicit PgAction_GroundQuestCheck(int const iCurGroundNo, SGroundKey const &rkGndKey, unsigned int iCombo);
...
//
class PgAction_ChangeClassCheck//전직이 다른 퀘스트의 조건이 되는지
	: public PgUtilAction
{
public:
