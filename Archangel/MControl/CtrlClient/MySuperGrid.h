...
protected:
	...
	bool AddServer(CTreeItem* pRoot, ERIC_SERVERINFO* pkInfo);
	void GetServerStatusText(EServerStatus eStatus , LPTSTR lpszText, int iTextSize);
	int GetServerStatusImageIndex(EServerStatus eStatus);
