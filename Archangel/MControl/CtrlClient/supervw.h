...
#define LOGBOX_HEIGHT	200
#define LOGBOX_GAP		10
...
public:
	CMySuperGrid m_List;
	BOOL m_bDrag;
	CListBoxEBX m_LogBox;
// Operations
public:
	void OutputLog(int iLevel, LPCTSTR fmt, ...);
...
protected:
	...
	afx_msg void OnStartAllChannel();
	afx_msg void OnStartCheckedChannel();
	afx_msg void OnStopAllChannel();
	afx_msg void OnStopCheckedChannel();
	//}}AFX_MSG
	DECLARE_MESSAGE_MAP()
};
