...
extern const MIDL_SERVER_INFO informer_ServerInfo;
...
extern const RPC_DISPATCH_TABLE informer_v1_0_DispatchTable;

static const RPC_SERVER_INTERFACE informer___RpcServerInterface =
    {
    sizeof(RPC_SERVER_INTERFACE),
    {{0xC11502DD,0x6086,0x4217,{0xB1,0xBA,0x02,0x25,0x36,0x27,0xD6,0x74}},{1,0}},
    {{0x8A885D04,0x1CEB,0x11C9,{0x9F,0xE8,0x08,0x00,0x2B,0x10,0x48,0x60}},{2,0}},
    (RPC_DISPATCH_TABLE*)&informer_v1_0_DispatchTable,
    1,
...
RPC_IF_HANDLE informer_v1_0_s_ifspec = (RPC_IF_HANDLE)& informer___RpcServerInterface;
...
static const MIDL_STUB_DESC informer_StubDesc = 
    {
    (void *)& informer___RpcServerInterface,
    MIDL_user_allocate,
    MIDL_user_free,
    0,
    0,
...
static const RPC_DISPATCH_FUNCTION informer_table[] =
    {
    NdrServerCall2,
    NdrServerCall2,
    NdrServerCall2,
...
static const RPC_DISPATCH_TABLE informer_v1_0_DispatchTable = 
    {
    9,
    (RPC_DISPATCH_FUNCTION*)informer_table
    };

static const SERVER_ROUTINE informer_ServerRoutineTable[] = 
    {
    (SERVER_ROUTINE)KickPlayer,
    (SERVER_ROUTINE)ChangePassword,
    (SERVER_ROUTINE)CreateAccount,
    (SERVER_ROUTINE)FreezeAccount,
    (SERVER_ROUTINE)AuxiliaryPassword,
    (SERVER_ROUTINE)AddPoint,
    (SERVER_ROUTINE)GiveItem,
    (SERVER_ROUTINE)GetPoint,
    (SERVER_ROUTINE)ChangeBirthday
    };

static const MIDL_SERVER_INFO informer_ServerInfo = 
    {
    &informer_StubDesc,
    informer_ServerRoutineTable,
    informer__MIDL_ProcFormatString.Format,
    informer_FormatStringOffsetTable,
    0,
    0,
    0,
    0};
