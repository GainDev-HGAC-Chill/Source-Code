#line 2 "C:\Program Files\Emergent\Gamebryo 2.2 Evaluation\Sdk\Win32\Shaders\Data\DX9\\Generated\\NiStandardMaterial\00002B9F-01000000-00000000-002D0012-P.hlsl"
//---------------------------------------------------------------------------
// Constant variables:
//---------------------------------------------------------------------------
...
Output Main(Input In)
{
    ...
    Light(In.WorldPos, WorldNormalOut_CallOut15, int(0), bool(true), float(1.0), 
        ...
        float3(0.0, 0.0, 0.0), float3(0.0, 0.0, 0.0), AmbientAccumOut_CallOut16, 
    ...
    Light(In.WorldPos, WorldNormalOut_CallOut15, int(2), bool(true), float(1.0), 
        ...
        g_SpotWorldDirection, g_MaterialPower, AmbientAccumOut_CallOut18, 
        DiffuseAccumOut_CallOut18, SpecularAccumOut_CallOut18, 
    ...
    ComputeShadingCoefficients(g_MaterialEmissive, Color_CallOut4, 
        In.VertexColors, g_MaterialSpecular, SpecularAccumOut_CallOut19, 
    ...
    MultiplyFloat3(Specular_CallOut20, ColorOut_CallOut11, Output_CallOut21);

	// Function call #22
    float3 Output_CallOut22;
    MultiplyFloat3(Diffuse_CallOut20, Output_CallOut14, Output_CallOut22);

	// Function call #23
    float3 OutputColor_CallOut23;
    CompositeFinalRGBColor(Output_CallOut22, Output_CallOut21, 
        OutputColor_CallOut23);

	// Function call #24
    CompositeFinalRGBAColor(OutputColor_CallOut23, Output_CallOut17, Out.Color);
