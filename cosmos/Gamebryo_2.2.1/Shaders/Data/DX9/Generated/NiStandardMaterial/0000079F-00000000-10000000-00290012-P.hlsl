#line 2 "C:\Program Files\Emergent\Gamebryo 2.2 Evaluation\Sdk\Win32\Shaders\Data\DX9\\Generated\\NiStandardMaterial\0000079F-00000000-10000000-00290012-P.hlsl"
//---------------------------------------------------------------------------
// Constant variables:
//---------------------------------------------------------------------------
...
Output Main(Input In)
{
    ...
    Light(In.WorldPos, WorldNormalOut_CallOut11, int(2), bool(true), float(1.0), 
        ...
        AmbientAccumOut_CallOut16, DiffuseAccumOut_CallOut16, 
        SpecularAccumOut_CallOut16, AmbientAccumOut_CallOut17, 
    ...
    MultiplyFloat3(Diffuse_CallOut19, Output_CallOut15, Output_CallOut20);
