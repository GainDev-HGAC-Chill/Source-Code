#line 2 "C:\Program Files\Emergent\Gamebryo 2.2 Evaluation\Sdk\Win32\Shaders\Data\DX9\\Generated\\NiStandardMaterial\0000031F-00000000-00000000-002D0011-P.hlsl"
//---------------------------------------------------------------------------
// Constant variables:
//---------------------------------------------------------------------------
...
Output Main(Input In)
{
    ...
    Light(In.WorldPos, WorldNormalOut_CallOut8, int(0), bool(true), float(1.0), 
    ...
    ComputeShadingCoefficients(g_MaterialEmissive, Color_CallOut2, 
        In.VertexColors, g_MaterialSpecular, SpecularAccumOut_CallOut11, 
    ...
    MultiplyFloat3(Diffuse_CallOut12, Color_CallOut7, Output_CallOut13);
	...
	// Function call #15
    CompositeFinalRGBAColor(OutputColor_CallOut14, Output_CallOut10, Out.Color);
