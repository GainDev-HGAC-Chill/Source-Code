#line 2 "C:\Program Files\Emergent\Gamebryo 2.2 Evaluation\Sdk\Win32\Shaders\Data\DX9\\Generated\\NiStandardMaterial\00000B0F-00100000-10000000-002C0012-P.hlsl"
//---------------------------------------------------------------------------
// Constant variables:
//---------------------------------------------------------------------------
...
Output Main(Input In)
{
    ...
    SplitColorAndOpacity(In.VertexColors, Color_CallOut6, Opacity_CallOut6);
    ...
    ScaleFloat3(ColorOut_CallOut5, float(2.0), Output_CallOut8);

	// Function call #9
    float3 WorldNormalOut_CallOut9;
    CalculateNormalFromColor(ColorOut_CallOut3, VectorOut_CallOut0, 
        VectorOut_CallOut2, VectorOut_CallOut1, int(0), WorldNormalOut_CallOut9);

	// Function call #10
    float3 Output_CallOut10;
    MultiplyFloat3(Color_CallOut7, Output_CallOut8, Output_CallOut10);

	// Function call #11
    float Output_CallOut11;
    MultiplyFloat(Opacity_CallOut6, Opacity_CallOut7, Output_CallOut11);

	// Function call #12
    float3 AmbientAccumOut_CallOut12;
    float3 DiffuseAccumOut_CallOut12;
    float3 SpecularAccumOut_CallOut12;
    Light(In.WorldPos, WorldNormalOut_CallOut9, int(1), bool(false), float(1.0), 
        float3(0.0, 0.0, 0.0), g_PointWorldPosition0, g_PointAmbient0, 
        ...
        float3(0.0, 0.0, 0.0), AmbientAccumOut_CallOut12, 
    ...
    Light(In.WorldPos, WorldNormalOut_CallOut9, int(0), bool(false), float(1.0), 
    ...
    Light(In.WorldPos, WorldNormalOut_CallOut9, int(2), bool(false), float(1.0), 
        float3(0.0, 0.0, 0.0), g_SpotWorldPosition0, g_SpotAmbient0, 
    ...
    Light(In.WorldPos, WorldNormalOut_CallOut9, int(2), bool(false), float(1.0), 
        float3(0.0, 0.0, 0.0), g_SpotWorldPosition, g_SpotAmbient, 
    ...
    ComputeShadingCoefficients(g_MaterialEmissive, Color_CallOut6, 
        ...
        DiffuseAccumOut_CallOut15, AmbientAccumOut_CallOut15, bool(false), 
        Diffuse_CallOut16, Specular_CallOut16);

	// Function call #17
    float3 Output_CallOut17;
    MultiplyFloat3(Diffuse_CallOut16, Output_CallOut10, Output_CallOut17);

	// Function call #18
    float3 OutputColor_CallOut18;
    CompositeFinalRGBColor(Output_CallOut17, Specular_CallOut16, 
