#line 2 "C:\Program Files\Emergent\Gamebryo 2.2.1 Source\Sdk\Win32\Shaders\Data\DX9\\Generated\\NiStandardMaterial\01001841-00000000-52200000-00000000-V.hlsl"
//---------------------------------------------------------------------------
// Constant variables:
//---------------------------------------------------------------------------
    ...
    out float3 WorldReflect)
{
    ...
    WorldReflect = reflect(-WorldViewVector, normalize(WorldNrm));
...
Output Main(Input In)
{
    ...
    NormalizeFloat3(WorldViewVector_CallOut6, VectorOut_CallOut7);

	// Function call #8
    float3 WorldReflect_CallOut8;
    WorldReflect(WorldNrm_CallOut3, WorldViewVector_CallOut6, 
        WorldReflect_CallOut8);

	// Function call #9
    float3 VectorOut_CallOut9;
    NormalizeFloat3(WorldReflect_CallOut8, VectorOut_CallOut9);
	...
	// Function call #11
    ProjectTextureCoordinates(VectorOut_CallOut9, 
