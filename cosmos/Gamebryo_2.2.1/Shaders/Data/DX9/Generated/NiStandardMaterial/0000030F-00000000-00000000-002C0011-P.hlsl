#line 2 "C:\Program Files\Emergent\Gamebryo 2.2 Evaluation\Sdk\Win32\Shaders\Data\DX9\\Generated\\NiStandardMaterial\0000030F-00000000-00000000-002C0011-P.hlsl"
//---------------------------------------------------------------------------
// Constant variables:
//---------------------------------------------------------------------------
...
Output Main(Input In)
{
    ...
    MultiplyFloat3(Diffuse_CallOut11, Color_CallOut6, Output_CallOut12);

	// Function call #13
    float3 OutputColor_CallOut13;
    CompositeFinalRGBColor(Output_CallOut12, Specular_CallOut11, 
        OutputColor_CallOut13);

	// Function call #14
    CompositeFinalRGBAColor(OutputColor_CallOut13, Output_CallOut9, Out.Color);
