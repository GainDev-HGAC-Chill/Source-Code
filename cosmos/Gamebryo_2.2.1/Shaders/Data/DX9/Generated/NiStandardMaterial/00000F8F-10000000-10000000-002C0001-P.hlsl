#line 2 "C:\Program Files\Emergent\Gamebryo 2.2 Evaluation\Sdk\Win32\Shaders\Data\DX9\\Generated\\NiStandardMaterial\00000F8F-10000000-10000000-002C0001-P.hlsl"
//---------------------------------------------------------------------------
// Constant variables:
//---------------------------------------------------------------------------
...
Output Main(Input In)
{
    ...
    NormalizeFloat3(In.TangentSpaceView, VectorOut_CallOut6);
    ...
    CalculateParallaxOffset(In.UVSet0, ColorOut_CallOut4, g_ParallaxOffset, 
        VectorOut_CallOut6, ParallaxOffsetUV_CallOut8);

	// Function call #9
    float3 ColorOut_CallOut9;
    TextureRGBSample(ParallaxOffsetUV_CallOut8, Dark, bool(false), 
        ColorOut_CallOut9);
    ...
    Light(In.WorldPos, WorldNormalOut_CallOut12, int(1), bool(false), 
        ...
        float3(0.0, 0.0, 0.0), AmbientAccumOut_CallOut13, 
    ...
    MultiplyFloat(Opacity_CallOut2, Opacity_CallOut14, Output_CallOut15);
    ...
    MultiplyFloat3(ColorOut_CallOut9, Color_CallOut14, Output_CallOut17);
    ...
    MultiplyFloat3(Output_CallOut17, Output_CallOut7, Output_CallOut19);

	// Function call #20
    float3 Output_CallOut20;
    MultiplyFloat3(Diffuse_CallOut18, Output_CallOut19, Output_CallOut20);

	// Function call #21
    float3 OutputColor_CallOut21;
    CompositeFinalRGBColor(Output_CallOut20, Specular_CallOut18, 
        OutputColor_CallOut21);

	// Function call #22
    CompositeFinalRGBAColor(OutputColor_CallOut21, Output_CallOut15, Out.Color);
