#line 2 "C:\Program Files\Emergent\Gamebryo 2.2 Evaluation\Sdk\Win32\Shaders\Data\DX9\\Generated\\NiStandardMaterial\0000030F-00000000-10000000-002C0011-P.hlsl"
//---------------------------------------------------------------------------
// Constant variables:
//---------------------------------------------------------------------------
...
Output Main(Input In)
{
    ...
    MultiplyFloat3(Diffuse_CallOut12, Color_CallOut6, Output_CallOut13);

	// Function call #14
    float3 OutputColor_CallOut14;
    CompositeFinalRGBColor(Output_CallOut13, Specular_CallOut12, 
        OutputColor_CallOut14);

	// Function call #15
    CompositeFinalRGBAColor(OutputColor_CallOut14, Output_CallOut9, Out.Color);
