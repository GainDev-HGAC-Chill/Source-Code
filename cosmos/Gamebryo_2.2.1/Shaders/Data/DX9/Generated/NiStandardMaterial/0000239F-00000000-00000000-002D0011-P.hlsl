#line 2 "C:\Program Files\Emergent\Gamebryo 2.2 Evaluation\Sdk\Win32\Shaders\Data\DX9\\Generated\\NiStandardMaterial\0000239F-00000000-00000000-002D0011-P.hlsl"
//---------------------------------------------------------------------------
// Constant variables:
//---------------------------------------------------------------------------
...
Output Main(Input In)
{
    ...
    Light(In.WorldPos, WorldNormalOut_CallOut12, int(2), bool(true), float(1.0), 
        ...
        SpecularAccumOut_CallOut13, AmbientAccumOut_CallOut15, 
    ...
    ComputeShadingCoefficients(g_MaterialEmissive, Color_CallOut4, 
        In.VertexColors, g_MaterialSpecular, SpecularAccumOut_CallOut15, 
    ...
    MultiplyFloat3(Specular_CallOut16, ColorOut_CallOut9, Output_CallOut17);

	// Function call #18
    float3 Output_CallOut18;
    MultiplyFloat3(Diffuse_CallOut16, Color_CallOut11, Output_CallOut18);

	// Function call #19
    float3 OutputColor_CallOut19;
    CompositeFinalRGBColor(Output_CallOut18, Output_CallOut17, 
