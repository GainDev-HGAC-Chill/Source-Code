#line 2 "C:\Program Files\Emergent\Gamebryo 2.2 Evaluation\Sdk\Win32\Shaders\Data\DX9\\Generated\\NiStandardMaterial\01000140-00000000-52143000-00000000-V.hlsl"
//---------------------------------------------------------------------------
// Constant variables:
//---------------------------------------------------------------------------
...
Output Main(Input In)
{
    ...
    Light(WorldPos_CallOut0, VectorOut_CallOut4, int(2), bool(true), float(1.0), 
        WorldViewVector_CallOut5, g_SpotWorldPosition, g_SpotAmbient, 
        g_SpotDiffuse, g_SpotSpecular, g_SpotAttenuation, g_SpotSpotAttenuation, 
        g_SpotWorldDirection, g_MaterialPower, AmbientAccumOut_CallOut10, 
        DiffuseAccumOut_CallOut10, SpecularAccumOut_CallOut10, 
    ...
    Light(WorldPos_CallOut0, VectorOut_CallOut4, int(2), bool(true), float(1.0), 
        WorldViewVector_CallOut5, g_SpotWorldPosition2, g_SpotAmbient2, 
        g_SpotDiffuse2, g_SpotSpecular2, g_SpotAttenuation2, 
        g_SpotSpotAttenuation2, g_SpotWorldDirection2, g_MaterialPower, 
        AmbientAccumOut_CallOut11, DiffuseAccumOut_CallOut11, 
    ...
    Light(WorldPos_CallOut0, VectorOut_CallOut4, int(2), bool(true), float(1.0), 
        WorldViewVector_CallOut5, g_SpotWorldPosition3, g_SpotAmbient3, 
        g_SpotDiffuse3, g_SpotSpecular3, g_SpotAttenuation3, 
        g_SpotSpotAttenuation3, g_SpotWorldDirection3, g_MaterialPower, 
