#line 2 "C:\Program Files\Emergent\Gamebryo 2.2 Evaluation\Sdk\Win32\Shaders\Data\DX9\\Generated\\NiStandardMaterial\00002B9F-01000000-10000000-002D0001-P.hlsl"
//---------------------------------------------------------------------------
// Constant variables:
//---------------------------------------------------------------------------
...
Output Main(Input In)
{
    ...
    ComputeShadingCoefficients(g_MaterialEmissive, Color_CallOut4, 
        In.VertexColors, g_MaterialSpecular, SpecularAccumOut_CallOut18, 
    ...
    MultiplyFloat3(Specular_CallOut19, ColorOut_CallOut11, Output_CallOut20);

	// Function call #21
    float3 Output_CallOut21;
    MultiplyFloat3(Diffuse_CallOut19, Output_CallOut14, Output_CallOut21);
	...
	// Function call #23
    CompositeFinalRGBAColor(OutputColor_CallOut22, Output_CallOut17, Out.Color);
