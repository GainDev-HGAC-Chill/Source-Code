#line 2 "C:\Program Files\Emergent\Gamebryo 2.2 Evaluation\Sdk\Win32\Shaders\Data\DX9\\Generated\\NiStandardMaterial\0000030F-00000000-10000000-002C0000-P.hlsl"
//---------------------------------------------------------------------------
// Constant variables:
//---------------------------------------------------------------------------
...
Output Main(Input In)
{
    ...
    MultiplyFloat3(Diffuse_CallOut10, Color_CallOut6, Output_CallOut11);

	// Function call #12
    float3 OutputColor_CallOut12;
    CompositeFinalRGBColor(Output_CallOut11, Specular_CallOut10, 
        OutputColor_CallOut12);

	// Function call #13
    CompositeFinalRGBAColor(OutputColor_CallOut12, Output_CallOut9, Out.Color);
