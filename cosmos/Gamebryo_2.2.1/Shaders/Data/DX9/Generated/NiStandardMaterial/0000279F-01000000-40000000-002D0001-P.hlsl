#line 2 "C:\Program Files\Emergent\Gamebryo 2.2 Evaluation\Sdk\Win32\Shaders\Data\DX9\\Generated\\NiStandardMaterial\0000279F-01000000-40000000-002D0001-P.hlsl"
//---------------------------------------------------------------------------
// Constant variables:
//---------------------------------------------------------------------------
...
Output Main(Input In)
{
    ...
    TextureRGBSample(In.UVSet0, Parallax, bool(false), ColorOut_CallOut7);

	// Function call #8
    float2 ParallaxOffsetUV_CallOut8;
    CalculateParallaxOffset(In.UVSet0, ColorOut_CallOut7, g_ParallaxOffset, 
        VectorOut_CallOut2, ParallaxOffsetUV_CallOut8);

	// Function call #9
    float4 ColorOut_CallOut9;
    TextureRGBASample(ParallaxOffsetUV_CallOut8, Base, bool(false), 
        ColorOut_CallOut9);

	// Function call #10
    float3 ColorOut_CallOut10;
    TextureRGBSample(ParallaxOffsetUV_CallOut8, Gloss, bool(false), 
        ColorOut_CallOut10);

	// Function call #11
    float4 ColorOut_CallOut11;
    TextureRGBASample(ParallaxOffsetUV_CallOut8, Normal, bool(false), 
        ColorOut_CallOut11);

	// Function call #12
    float3 Color_CallOut12;
    float Opacity_CallOut12;
    SplitColorAndOpacity(ColorOut_CallOut9, Color_CallOut12, Opacity_CallOut12);

	// Function call #13
    float Output_CallOut13;
    MultiplyFloat(Opacity_CallOut4, Opacity_CallOut12, Output_CallOut13);

	// Function call #14
    float3 WorldNormalOut_CallOut14;
    CalculateNormalFromColor(ColorOut_CallOut11, VectorOut_CallOut0, 
    ...
    MultiplyFloat3(ColorOut_CallOut5, Color_CallOut12, Output_CallOut16);
    ...
    Light(In.WorldPos, WorldNormalOut_CallOut14, int(1), bool(true), float(1.0), 
        ...
        float3(-1.0, -1.0, 0.0), float3(1.0, 0.0, 0.0), g_MaterialPower, 
        AmbientAccumOut_CallOut15, DiffuseAccumOut_CallOut15, 
        SpecularAccumOut_CallOut15, AmbientAccumOut_CallOut17, 
    ...
    Light(In.WorldPos, WorldNormalOut_CallOut14, int(1), bool(true), float(1.0), 
        ...
        SpecularAccumOut_CallOut17, AmbientAccumOut_CallOut18, 
    ...
    ComputeShadingCoefficients(g_MaterialEmissive, Color_CallOut4, 
        In.VertexColors, g_MaterialSpecular, SpecularAccumOut_CallOut20, 
        DiffuseAccumOut_CallOut20, AmbientAccumOut_CallOut20, bool(false), 
        Diffuse_CallOut21, Specular_CallOut21);

	// Function call #22
    float3 Output_CallOut22;
    MultiplyFloat3(Specular_CallOut21, ColorOut_CallOut10, Output_CallOut22);

	// Function call #23
    float3 Output_CallOut23;
    MultiplyFloat3(Diffuse_CallOut21, Output_CallOut16, Output_CallOut23);

	// Function call #24
    float3 OutputColor_CallOut24;
    CompositeFinalRGBColor(Output_CallOut23, Output_CallOut22, 
        OutputColor_CallOut24);

	// Function call #25
    CompositeFinalRGBAColor(OutputColor_CallOut24, Output_CallOut13, Out.Color);
