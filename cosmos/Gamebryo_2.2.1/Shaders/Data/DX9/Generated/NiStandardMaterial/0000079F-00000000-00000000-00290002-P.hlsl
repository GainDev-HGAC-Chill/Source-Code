#line 2 "C:\Program Files\Emergent\Gamebryo 2.2 Evaluation\Sdk\Win32\Shaders\Data\DX9\\Generated\\NiStandardMaterial\0000079F-00000000-00000000-00290002-P.hlsl"
//---------------------------------------------------------------------------
// Constant variables:
//---------------------------------------------------------------------------
...
Output Main(Input In)
{
    ...
    MultiplyFloat(Opacity_CallOut4, Opacity_CallOut13, Output_CallOut14);

	// Function call #15
    float3 Output_CallOut15;
    MultiplyFloat3(ColorOut_CallOut8, Color_CallOut13, Output_CallOut15);
    ...
    Light(In.WorldPos, WorldNormalOut_CallOut11, int(2), bool(true), float(1.0), 
        ...
        g_SpotWorldDirection, g_MaterialPower, AmbientAccumOut_CallOut12, 
    ...
    ComputeShadingCoefficients(g_MaterialEmissive, Color_CallOut4, 
        g_MaterialAmbient, g_MaterialSpecular, SpecularAccumOut_CallOut16, 
    ...
    MultiplyFloat3(Diffuse_CallOut17, Output_CallOut15, Output_CallOut18);
