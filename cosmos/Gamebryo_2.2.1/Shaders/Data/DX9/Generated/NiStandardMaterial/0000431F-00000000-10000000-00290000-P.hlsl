#line 2 "C:\Program Files\Emergent\Gamebryo 2.2 Evaluation\Sdk\Win32\Shaders\Data\DX9\\Generated\\NiStandardMaterial\0000431F-00000000-10000000-00290000-P.hlsl"
//---------------------------------------------------------------------------
// Constant variables:
//---------------------------------------------------------------------------
...
Output Main(Input In)
{
    ...
    TextureRGBSample(In.UVSet0, Glow, bool(false), ColorOut_CallOut6);
    ...
    MultiplyFloat3(Diffuse_CallOut12, Color_CallOut8, Output_CallOut13);

	// Function call #14
    float3 Output_CallOut14;
    AddFloat3(Output_CallOut13, ColorOut_CallOut6, Output_CallOut14);

	// Function call #15
    float3 OutputColor_CallOut15;
    CompositeFinalRGBColor(Output_CallOut14, Specular_CallOut12, 
