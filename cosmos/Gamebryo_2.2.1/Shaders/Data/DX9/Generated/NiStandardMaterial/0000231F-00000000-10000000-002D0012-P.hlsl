#line 2 "C:\Program Files\Emergent\Gamebryo 2.2 Evaluation\Sdk\Win32\Shaders\Data\DX9\\Generated\\NiStandardMaterial\0000231F-00000000-10000000-002D0012-P.hlsl"
//---------------------------------------------------------------------------
// Constant variables:
//---------------------------------------------------------------------------
...
Output Main(Input In)
{
    ...
    Light(In.WorldPos, WorldNormalOut_CallOut9, int(2), bool(true), float(1.0), 
        ...
        g_SpotWorldDirection, g_MaterialPower, AmbientAccumOut_CallOut13, 
        DiffuseAccumOut_CallOut13, SpecularAccumOut_CallOut13, 
    ...
    ComputeShadingCoefficients(g_MaterialEmissive, Color_CallOut2, 
        In.VertexColors, g_MaterialSpecular, SpecularAccumOut_CallOut14, 
