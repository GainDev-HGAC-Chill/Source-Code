#line 2 "C:\Program Files\Emergent\Gamebryo 2.2 Evaluation\Sdk\Win32\Shaders\Data\DX9\\Generated\\NiStandardMaterial\0000239F-00000000-00000000-002D0021-P.hlsl"
//---------------------------------------------------------------------------
// Constant variables:
//---------------------------------------------------------------------------
...
Output Main(Input In)
{
    ...
    Light(In.WorldPos, WorldNormalOut_CallOut12, int(0), bool(true), float(1.0), 
        VectorOut_CallOut5, g_DirWorldPosition0, g_DirAmbient0, g_DirDiffuse0, 
        g_DirSpecular0, float3(0.0, 1.0, 0.0), float3(-1.0, -1.0, 0.0), 
        g_DirWorldDirection0, g_MaterialPower, g_AmbientLight, 
        float3(0.0, 0.0, 0.0), float3(0.0, 0.0, 0.0), AmbientAccumOut_CallOut13, 
        DiffuseAccumOut_CallOut13, SpecularAccumOut_CallOut13);

	// Function call #14
    float Output_CallOut14;
    MultiplyFloat(Opacity_CallOut4, Opacity_CallOut11, Output_CallOut14);
    ...
    Light(In.WorldPos, WorldNormalOut_CallOut12, int(0), bool(true), float(1.0), 
        VectorOut_CallOut5, g_DirWorldPosition, g_DirAmbient, g_DirDiffuse, 
        g_DirSpecular, float3(0.0, 1.0, 0.0), float3(-1.0, -1.0, 0.0), 
        g_DirWorldDirection, g_MaterialPower, AmbientAccumOut_CallOut13, 
        DiffuseAccumOut_CallOut13, SpecularAccumOut_CallOut13, 
    ...
    MultiplyFloat3(Specular_CallOut17, ColorOut_CallOut9, Output_CallOut18);

	// Function call #19
    float3 Output_CallOut19;
    MultiplyFloat3(Diffuse_CallOut17, Color_CallOut11, Output_CallOut19);

	// Function call #20
    float3 OutputColor_CallOut20;
    CompositeFinalRGBColor(Output_CallOut19, Output_CallOut18, 
