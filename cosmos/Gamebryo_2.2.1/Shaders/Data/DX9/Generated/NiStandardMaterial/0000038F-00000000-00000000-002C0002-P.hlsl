#line 2 "C:\Program Files\Emergent\Gamebryo 2.2 Evaluation\Sdk\Win32\Shaders\Data\DX9\\Generated\\NiStandardMaterial\0000038F-00000000-00000000-002C0002-P.hlsl"
//---------------------------------------------------------------------------
// Constant variables:
//---------------------------------------------------------------------------
...
Output Main(Input In)
{
    ...
    MultiplyFloat3(Diffuse_CallOut14, Color_CallOut9, Output_CallOut15);

	// Function call #16
    float3 OutputColor_CallOut16;
    CompositeFinalRGBColor(Output_CallOut15, Specular_CallOut14, 
        OutputColor_CallOut16);

	// Function call #17
    CompositeFinalRGBAColor(OutputColor_CallOut16, Output_CallOut12, Out.Color);
