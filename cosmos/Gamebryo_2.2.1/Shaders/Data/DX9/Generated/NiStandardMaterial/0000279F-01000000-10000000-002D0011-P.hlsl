#line 2 "C:\Program Files\Emergent\Gamebryo 2.2 Evaluation\Sdk\Win32\Shaders\Data\DX9\\Generated\\NiStandardMaterial\0000279F-01000000-10000000-002D0011-P.hlsl"
//---------------------------------------------------------------------------
// Constant variables:
//---------------------------------------------------------------------------
...
Output Main(Input In)
{
    ...
    Light(In.WorldPos, WorldNormalOut_CallOut14, int(0), bool(true), float(1.0), 
        VectorOut_CallOut6, g_DirWorldPosition0, g_DirAmbient0, g_DirDiffuse0, 
        g_DirSpecular0, float3(0.0, 1.0, 0.0), float3(-1.0, -1.0, 0.0), 
        g_DirWorldDirection0, g_MaterialPower, AmbientAccumOut_CallOut15, 
        DiffuseAccumOut_CallOut15, SpecularAccumOut_CallOut15, 
    ...
    MultiplyFloat3(Specular_CallOut19, ColorOut_CallOut10, Output_CallOut20);
	...
	// Function call #23
    CompositeFinalRGBAColor(OutputColor_CallOut22, Output_CallOut13, Out.Color);
