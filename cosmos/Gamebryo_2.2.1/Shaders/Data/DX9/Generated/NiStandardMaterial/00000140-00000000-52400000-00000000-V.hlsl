#line 2 "C:\Program Files\Emergent\Gamebryo 2.2 Evaluation\Sdk\Win32\Shaders\Data\DX9\\Generated\\NiStandardMaterial\00000140-00000000-52400000-00000000-V.hlsl"
//---------------------------------------------------------------------------
// Constant variables:
//---------------------------------------------------------------------------
...
Output Main(Input In)
{
    ...
    Light(WorldPos_CallOut0, VectorOut_CallOut4, int(0), bool(true), float(1.0), 
        WorldViewVector_CallOut5, g_DirWorldPosition, g_DirAmbient, 
        g_DirDiffuse, g_DirSpecular, float3(0.0, 1.0, 0.0), 
        float3(-1.0, -1.0, 0.0), g_DirWorldDirection, g_MaterialPower, 
        AmbientAccumOut_CallOut6, DiffuseAccumOut_CallOut6, 
    ...
    Light(WorldPos_CallOut0, VectorOut_CallOut4, int(0), bool(true), float(1.0), 
        WorldViewVector_CallOut5, g_DirWorldPosition2, g_DirAmbient2, 
        g_DirDiffuse2, g_DirSpecular2, float3(0.0, 1.0, 0.0), 
        float3(-1.0, -1.0, 0.0), g_DirWorldDirection2, g_MaterialPower, 
    ...
    Light(WorldPos_CallOut0, VectorOut_CallOut4, int(0), bool(true), float(1.0), 
        WorldViewVector_CallOut5, g_DirWorldPosition3, g_DirAmbient3, 
        g_DirDiffuse3, g_DirSpecular3, float3(0.0, 1.0, 0.0), 
        float3(-1.0, -1.0, 0.0), g_DirWorldDirection3, g_MaterialPower, 
