#line 2 "C:\Program Files\Emergent\Gamebryo 2.2 Evaluation\Sdk\Win32\Shaders\Data\DX9\\Generated\\NiStandardMaterial\0000031F-00000000-10000000-00290002-P.hlsl"
//---------------------------------------------------------------------------
// Constant variables:
//---------------------------------------------------------------------------
...
Output Main(Input In)
{
    ...
    Light(In.WorldPos, WorldNormalOut_CallOut8, int(1), bool(true), float(1.0), 
    ...
    MultiplyFloat(Opacity_CallOut2, Opacity_CallOut7, Output_CallOut10);

	// Function call #11
    float3 AmbientAccumOut_CallOut11;
    float3 DiffuseAccumOut_CallOut11;
    float3 SpecularAccumOut_CallOut11;
    Light(In.WorldPos, WorldNormalOut_CallOut8, int(2), bool(true), float(1.0), 
        ...
        AmbientAccumOut_CallOut9, DiffuseAccumOut_CallOut9, 
        SpecularAccumOut_CallOut9, AmbientAccumOut_CallOut11, 
    ...
    Light(In.WorldPos, WorldNormalOut_CallOut8, int(2), bool(true), float(1.0), 
        ...
        g_SpotWorldDirection, g_MaterialPower, AmbientAccumOut_CallOut11, 
        DiffuseAccumOut_CallOut11, SpecularAccumOut_CallOut11, 
	...
	// Function call #16
    CompositeFinalRGBAColor(OutputColor_CallOut15, Output_CallOut10, Out.Color);
