#line 2 "C:\Program Files\Emergent\Gamebryo 2.2 Evaluation\Sdk\Win32\Shaders\Data\DX9\\Generated\\NiStandardMaterial\03002101-00000800-00000000-00080000-P.hlsl"
//---------------------------------------------------------------------------
// Constant variables:
//---------------------------------------------------------------------------
...
Output Main(Input In)
{
    ...
    TextureRGBSample(In.UVSet1, EnvironmentMap, bool(false), ColorOut_CallOut3);
    ...
    MultiplyFloat3(ColorOut_CallOut2, ColorOut_CallOut3, Output_CallOut7);

	// Function call #8
    float3 OutputColor_CallOut8;
    CompositeFinalRGBColor(Output_CallOut5, Output_CallOut7, 
        OutputColor_CallOut8);

	// Function call #9
    CompositeFinalRGBAColor(OutputColor_CallOut8, Output_CallOut6, Out.Color);
