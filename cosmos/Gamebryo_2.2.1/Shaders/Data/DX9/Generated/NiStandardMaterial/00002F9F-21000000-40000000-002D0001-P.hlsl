#line 2 "C:\Program Files\Emergent\Gamebryo 2.2 Evaluation\Sdk\Win32\Shaders\Data\DX9\\Generated\\NiStandardMaterial\00002F9F-21000000-40000000-002D0001-P.hlsl"
//---------------------------------------------------------------------------
// Constant variables:
//---------------------------------------------------------------------------
...
struct Input
{
    ...
    float2 UVSet1 : TEXCOORD7;
    float2 UVSet2 : TEXCOORD8;
...
Output Main(Input In)
{
    ...
    SplitColorAndOpacity(In.VertexColors, Color_CallOut4, Opacity_CallOut4);

	// Function call #5
    float3 ColorOut_CallOut5;
    TextureRGBSample(In.UVSet1, Dark, bool(false), ColorOut_CallOut5);

	// Function call #6
    float3 ColorOut_CallOut6;
    TextureRGBSample(In.UVSet2, Detail, bool(false), ColorOut_CallOut6);
    ...
    ScaleFloat3(ColorOut_CallOut6, float(2.0), Output_CallOut8);

	// Function call #9
    float3 ColorOut_CallOut9;
    TextureRGBSample(In.UVSet0, Parallax, bool(false), ColorOut_CallOut9);

	// Function call #10
    float2 ParallaxOffsetUV_CallOut10;
    CalculateParallaxOffset(In.UVSet0, ColorOut_CallOut9, g_ParallaxOffset, 
        VectorOut_CallOut2, ParallaxOffsetUV_CallOut10);

	// Function call #11
    float4 ColorOut_CallOut11;
    TextureRGBASample(ParallaxOffsetUV_CallOut10, Base, bool(false), 
        ColorOut_CallOut11);

	// Function call #12
    float3 ColorOut_CallOut12;
    TextureRGBSample(ParallaxOffsetUV_CallOut10, Gloss, bool(false), 
        ColorOut_CallOut12);

	// Function call #13
    float4 ColorOut_CallOut13;
    TextureRGBASample(ParallaxOffsetUV_CallOut10, Normal, bool(false), 
        ColorOut_CallOut13);
	...
	// Function call #16
    float3 WorldNormalOut_CallOut16;
    CalculateNormalFromColor(ColorOut_CallOut13, VectorOut_CallOut0, 
        VectorOut_CallOut3, VectorOut_CallOut1, int(0), 
        WorldNormalOut_CallOut16);

	// Function call #17
    float3 AmbientAccumOut_CallOut17;
    float3 DiffuseAccumOut_CallOut17;
    float3 SpecularAccumOut_CallOut17;
    Light(In.WorldPos, WorldNormalOut_CallOut16, int(1), bool(true), float(1.0), 
    ...
    MultiplyFloat3(ColorOut_CallOut5, Color_CallOut14, Output_CallOut18);
    ...
    Light(In.WorldPos, WorldNormalOut_CallOut16, int(1), bool(true), float(1.0), 
        ...
        float3(-1.0, -1.0, 0.0), float3(1.0, 0.0, 0.0), g_MaterialPower, 
        AmbientAccumOut_CallOut17, DiffuseAccumOut_CallOut17, 
        SpecularAccumOut_CallOut17, AmbientAccumOut_CallOut19, 
        DiffuseAccumOut_CallOut19, SpecularAccumOut_CallOut19);

	// Function call #20
    float3 Output_CallOut20;
    MultiplyFloat3(Output_CallOut18, Output_CallOut8, Output_CallOut20);

	// Function call #21
    float3 AmbientAccumOut_CallOut21;
    float3 DiffuseAccumOut_CallOut21;
    float3 SpecularAccumOut_CallOut21;
    Light(In.WorldPos, WorldNormalOut_CallOut16, int(1), bool(true), float(1.0), 
        ...
        SpecularAccumOut_CallOut19, AmbientAccumOut_CallOut21, 
        DiffuseAccumOut_CallOut21, SpecularAccumOut_CallOut21);

	// Function call #22
    float3 AmbientAccumOut_CallOut22;
    float3 DiffuseAccumOut_CallOut22;
    float3 SpecularAccumOut_CallOut22;
    Light(In.WorldPos, WorldNormalOut_CallOut16, int(1), bool(true), float(1.0), 
        VectorOut_CallOut7, g_PointWorldPosition3, g_PointAmbient3, 
        g_PointDiffuse3, g_PointSpecular3, g_PointAttenuation3, 
        float3(-1.0, -1.0, 0.0), float3(1.0, 0.0, 0.0), g_MaterialPower, 
        AmbientAccumOut_CallOut21, DiffuseAccumOut_CallOut21, 
        SpecularAccumOut_CallOut21, AmbientAccumOut_CallOut22, 
        DiffuseAccumOut_CallOut22, SpecularAccumOut_CallOut22);

	// Function call #23
    float3 AmbientAccumOut_CallOut23;
    float3 DiffuseAccumOut_CallOut23;
    float3 SpecularAccumOut_CallOut23;
    Light(In.WorldPos, WorldNormalOut_CallOut16, int(2), bool(true), float(1.0), 
        ...
        AmbientAccumOut_CallOut22, DiffuseAccumOut_CallOut22, 
        SpecularAccumOut_CallOut22, AmbientAccumOut_CallOut23, 
        DiffuseAccumOut_CallOut23, SpecularAccumOut_CallOut23);

	// Function call #24
    float3 Diffuse_CallOut24;
    float3 Specular_CallOut24;
    ComputeShadingCoefficients(g_MaterialEmissive, Color_CallOut4, 
        In.VertexColors, g_MaterialSpecular, SpecularAccumOut_CallOut23, 
        DiffuseAccumOut_CallOut23, AmbientAccumOut_CallOut23, bool(false), 
        Diffuse_CallOut24, Specular_CallOut24);

	// Function call #25
    float3 Output_CallOut25;
    MultiplyFloat3(Specular_CallOut24, ColorOut_CallOut12, Output_CallOut25);

	// Function call #26
    float3 Output_CallOut26;
    MultiplyFloat3(Diffuse_CallOut24, Output_CallOut20, Output_CallOut26);

	// Function call #27
    float3 OutputColor_CallOut27;
    CompositeFinalRGBColor(Output_CallOut26, Output_CallOut25, 
        OutputColor_CallOut27);

	// Function call #28
    CompositeFinalRGBAColor(OutputColor_CallOut27, Output_CallOut15, Out.Color);
