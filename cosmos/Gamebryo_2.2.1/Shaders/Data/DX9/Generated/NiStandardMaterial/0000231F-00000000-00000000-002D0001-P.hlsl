#line 2 "C:\Program Files\Emergent\Gamebryo 2.2 Evaluation\Sdk\Win32\Shaders\Data\DX9\\Generated\\NiStandardMaterial\0000231F-00000000-00000000-002D0001-P.hlsl"
//---------------------------------------------------------------------------
// Constant variables:
//---------------------------------------------------------------------------
...
Output Main(Input In)
{
    ...
    ComputeShadingCoefficients(g_MaterialEmissive, Color_CallOut2, 
        In.VertexColors, g_MaterialSpecular, SpecularAccumOut_CallOut10, 
    ...
    MultiplyFloat3(Specular_CallOut12, ColorOut_CallOut6, Output_CallOut13);

	// Function call #14
    float3 Output_CallOut14;
    MultiplyFloat3(Diffuse_CallOut12, Color_CallOut8, Output_CallOut14);

	// Function call #15
    float3 OutputColor_CallOut15;
    CompositeFinalRGBColor(Output_CallOut14, Output_CallOut13, 
        OutputColor_CallOut15);

	// Function call #16
    CompositeFinalRGBAColor(OutputColor_CallOut15, Output_CallOut11, Out.Color);
