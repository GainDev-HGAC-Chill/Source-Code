#line 2 "C:\Program Files\Emergent\Gamebryo 2.2 Evaluation\Sdk\Win32\Shaders\Data\DX9\\Generated\\NiStandardMaterial\0000279F-01000000-00000000-002D0021-P.hlsl"
//---------------------------------------------------------------------------
// Constant variables:
//---------------------------------------------------------------------------
...
Output Main(Input In)
{
    ...
    Light(In.WorldPos, WorldNormalOut_CallOut14, int(0), bool(true), float(1.0), 
        ...
        float3(0.0, 0.0, 0.0), float3(0.0, 0.0, 0.0), AmbientAccumOut_CallOut15, 
    ...
    Light(In.WorldPos, WorldNormalOut_CallOut14, int(0), bool(true), float(1.0), 
        ...
        g_DirWorldDirection, g_MaterialPower, AmbientAccumOut_CallOut15, 
        DiffuseAccumOut_CallOut15, SpecularAccumOut_CallOut15, 
