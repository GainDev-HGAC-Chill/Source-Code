#line 2 "C:\Program Files\Emergent\Gamebryo 2.2 Evaluation\Sdk\Win32\Shaders\Data\DX9\\Generated\\NiStandardMaterial\0000038F-00010000-10000000-00280011-P.hlsl"
//---------------------------------------------------------------------------
// Constant variables:
//---------------------------------------------------------------------------
...
Output Main(Input In)
{
    ...
    TextureRGBASample(In.UVSet1, Base, bool(false), ColorOut_CallOut5);
    ...
    MultiplyFloat(Opacity_CallOut2, Opacity_CallOut7, Output_CallOut9);
    ...
    Light(In.WorldPos, WorldNormalOut_CallOut11, int(1), bool(false), 
    ...
    Light(In.WorldPos, WorldNormalOut_CallOut11, int(0), bool(false), 
    ...
    Light(In.WorldPos, WorldNormalOut_CallOut11, int(2), bool(false), 
    ...
    MultiplyFloat3(Diffuse_CallOut15, Color_CallOut7, Output_CallOut16);
