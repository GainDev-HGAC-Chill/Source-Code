#line 2 "C:\Program Files\Emergent\Gamebryo 2.2 Evaluation\Sdk\Win32\Shaders\Data\DX9\\Generated\\NiStandardMaterial\00000140-00000000-52006000-00000000-V.hlsl"
//---------------------------------------------------------------------------
// Constant variables:
//---------------------------------------------------------------------------
...
Output Main(Input In)
{
    ...
    Light(WorldPos_CallOut0, VectorOut_CallOut4, int(1), bool(true), float(1.0), 
        WorldViewVector_CallOut5, g_PointWorldPosition0, g_PointAmbient0, 
    ...
    Light(WorldPos_CallOut0, VectorOut_CallOut4, int(1), bool(true), float(1.0), 
        WorldViewVector_CallOut5, g_PointWorldPosition, g_PointAmbient, 
    ...
    Light(WorldPos_CallOut0, VectorOut_CallOut4, int(1), bool(true), float(1.0), 
        WorldViewVector_CallOut5, g_PointWorldPosition2, g_PointAmbient2, 
    ...
    Light(WorldPos_CallOut0, VectorOut_CallOut4, int(1), bool(true), float(1.0), 
        WorldViewVector_CallOut5, g_PointWorldPosition3, g_PointAmbient3, 
    ...
    Light(WorldPos_CallOut0, VectorOut_CallOut4, int(1), bool(true), float(1.0), 
        WorldViewVector_CallOut5, g_PointWorldPosition4, g_PointAmbient4, 
        g_PointDiffuse4, g_PointSpecular4, g_PointAttenuation4, 
        float3(-1.0, -1.0, 0.0), float3(1.0, 0.0, 0.0), g_MaterialPower, 
        AmbientAccumOut_CallOut9, DiffuseAccumOut_CallOut9, 
        SpecularAccumOut_CallOut9, AmbientAccumOut_CallOut10, 
    ...
    Light(WorldPos_CallOut0, VectorOut_CallOut4, int(1), bool(true), float(1.0), 
        WorldViewVector_CallOut5, g_PointWorldPosition5, g_PointAmbient5, 
        g_PointDiffuse5, g_PointSpecular5, g_PointAttenuation5, 
        float3(-1.0, -1.0, 0.0), float3(1.0, 0.0, 0.0), g_MaterialPower, 
        AmbientAccumOut_CallOut10, DiffuseAccumOut_CallOut10, 
        SpecularAccumOut_CallOut10, AmbientAccumOut_CallOut11, 
