#line 2 "C:\Program Files\Emergent\Gamebryo 2.2 Evaluation\Sdk\Win32\Shaders\Data\DX9\\Generated\\NiStandardMaterial\00002B9F-01000000-40000000-002D0001-P.hlsl"
//---------------------------------------------------------------------------
// Constant variables:
//---------------------------------------------------------------------------
...
Output Main(Input In)
{
    ...
    TextureRGBSample(In.UVSet1, Detail, bool(false), ColorOut_CallOut5);
    ...
    ScaleFloat3(ColorOut_CallOut5, float(2.0), Output_CallOut7);

	// Function call #8
    float3 ColorOut_CallOut8;
    TextureRGBSample(In.UVSet0, Parallax, bool(false), ColorOut_CallOut8);

	// Function call #9
    float2 ParallaxOffsetUV_CallOut9;
    CalculateParallaxOffset(In.UVSet0, ColorOut_CallOut8, g_ParallaxOffset, 
        VectorOut_CallOut2, ParallaxOffsetUV_CallOut9);

	// Function call #10
    float4 ColorOut_CallOut10;
    TextureRGBASample(ParallaxOffsetUV_CallOut9, Base, bool(false), 
        ColorOut_CallOut10);

	// Function call #11
    float3 ColorOut_CallOut11;
    TextureRGBSample(ParallaxOffsetUV_CallOut9, Gloss, bool(false), 
        ColorOut_CallOut11);

	// Function call #12
    float4 ColorOut_CallOut12;
    TextureRGBASample(ParallaxOffsetUV_CallOut9, Normal, bool(false), 
        ColorOut_CallOut12);

	// Function call #13
    float3 Color_CallOut13;
    float Opacity_CallOut13;
    SplitColorAndOpacity(ColorOut_CallOut10, Color_CallOut13, Opacity_CallOut13);

	// Function call #14
    float3 Output_CallOut14;
    MultiplyFloat3(Color_CallOut13, Output_CallOut7, Output_CallOut14);

	// Function call #15
    float3 WorldNormalOut_CallOut15;
    CalculateNormalFromColor(ColorOut_CallOut12, VectorOut_CallOut0, 
        VectorOut_CallOut3, VectorOut_CallOut1, int(0), 
        WorldNormalOut_CallOut15);

	// Function call #16
    float3 AmbientAccumOut_CallOut16;
    float3 DiffuseAccumOut_CallOut16;
    float3 SpecularAccumOut_CallOut16;
    Light(In.WorldPos, WorldNormalOut_CallOut15, int(1), bool(true), float(1.0), 
        ...
        AmbientAccumOut_CallOut16, DiffuseAccumOut_CallOut16, 
        SpecularAccumOut_CallOut16);

	// Function call #17
    float Output_CallOut17;
    MultiplyFloat(Opacity_CallOut4, Opacity_CallOut13, Output_CallOut17);
    ...
    Light(In.WorldPos, WorldNormalOut_CallOut15, int(1), bool(true), float(1.0), 
        ...
        float3(-1.0, -1.0, 0.0), float3(1.0, 0.0, 0.0), g_MaterialPower, 
        AmbientAccumOut_CallOut16, DiffuseAccumOut_CallOut16, 
        SpecularAccumOut_CallOut16, AmbientAccumOut_CallOut18, 
        DiffuseAccumOut_CallOut18, SpecularAccumOut_CallOut18);
    ...
    Light(In.WorldPos, WorldNormalOut_CallOut15, int(1), bool(true), float(1.0), 
        VectorOut_CallOut6, g_PointWorldPosition2, g_PointAmbient2, 
        g_PointDiffuse2, g_PointSpecular2, g_PointAttenuation2, 
        float3(-1.0, -1.0, 0.0), float3(1.0, 0.0, 0.0), g_MaterialPower, 
        AmbientAccumOut_CallOut18, DiffuseAccumOut_CallOut18, 
        SpecularAccumOut_CallOut18, AmbientAccumOut_CallOut19, 
        DiffuseAccumOut_CallOut19, SpecularAccumOut_CallOut19);

	// Function call #20
    float3 AmbientAccumOut_CallOut20;
    float3 DiffuseAccumOut_CallOut20;
    float3 SpecularAccumOut_CallOut20;
    Light(In.WorldPos, WorldNormalOut_CallOut15, int(1), bool(true), float(1.0), 
        VectorOut_CallOut6, g_PointWorldPosition3, g_PointAmbient3, 
        g_PointDiffuse3, g_PointSpecular3, g_PointAttenuation3, 
        float3(-1.0, -1.0, 0.0), float3(1.0, 0.0, 0.0), g_MaterialPower, 
        AmbientAccumOut_CallOut19, DiffuseAccumOut_CallOut19, 
        SpecularAccumOut_CallOut19, AmbientAccumOut_CallOut20, 
        DiffuseAccumOut_CallOut20, SpecularAccumOut_CallOut20);

	// Function call #21
    float3 AmbientAccumOut_CallOut21;
    float3 DiffuseAccumOut_CallOut21;
    float3 SpecularAccumOut_CallOut21;
    Light(In.WorldPos, WorldNormalOut_CallOut15, int(2), bool(true), float(1.0), 
        ...
        AmbientAccumOut_CallOut20, DiffuseAccumOut_CallOut20, 
        SpecularAccumOut_CallOut20, AmbientAccumOut_CallOut21, 
        DiffuseAccumOut_CallOut21, SpecularAccumOut_CallOut21);

	// Function call #22
    float3 Diffuse_CallOut22;
    float3 Specular_CallOut22;
    ComputeShadingCoefficients(g_MaterialEmissive, Color_CallOut4, 
        In.VertexColors, g_MaterialSpecular, SpecularAccumOut_CallOut21, 
        DiffuseAccumOut_CallOut21, AmbientAccumOut_CallOut21, bool(false), 
        Diffuse_CallOut22, Specular_CallOut22);

	// Function call #23
    float3 Output_CallOut23;
    MultiplyFloat3(Specular_CallOut22, ColorOut_CallOut11, Output_CallOut23);

	// Function call #24
    float3 Output_CallOut24;
    MultiplyFloat3(Diffuse_CallOut22, Output_CallOut14, Output_CallOut24);

	// Function call #25
    float3 OutputColor_CallOut25;
    CompositeFinalRGBColor(Output_CallOut24, Output_CallOut23, 
        OutputColor_CallOut25);

	// Function call #26
    CompositeFinalRGBAColor(OutputColor_CallOut25, Output_CallOut17, Out.Color);
