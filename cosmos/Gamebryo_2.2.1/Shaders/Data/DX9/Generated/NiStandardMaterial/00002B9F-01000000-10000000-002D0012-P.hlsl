#line 2 "C:\Program Files\Emergent\Gamebryo 2.2 Evaluation\Sdk\Win32\Shaders\Data\DX9\\Generated\\NiStandardMaterial\00002B9F-01000000-10000000-002D0012-P.hlsl"
//---------------------------------------------------------------------------
// Constant variables:
//---------------------------------------------------------------------------
...
Output Main(Input In)
{
    ...
    Light(In.WorldPos, WorldNormalOut_CallOut15, int(0), bool(true), float(1.0), 
        VectorOut_CallOut6, g_DirWorldPosition0, g_DirAmbient0, g_DirDiffuse0, 
        g_DirSpecular0, float3(0.0, 1.0, 0.0), float3(-1.0, -1.0, 0.0), 
        g_DirWorldDirection0, g_MaterialPower, AmbientAccumOut_CallOut16, 
    ...
    Light(In.WorldPos, WorldNormalOut_CallOut15, int(2), bool(true), float(1.0), 
        ...
        g_SpotWorldDirection, g_MaterialPower, AmbientAccumOut_CallOut19, 
        DiffuseAccumOut_CallOut19, SpecularAccumOut_CallOut19, 
        AmbientAccumOut_CallOut20, DiffuseAccumOut_CallOut20, 
        SpecularAccumOut_CallOut20);
    ...
    MultiplyFloat3(Specular_CallOut21, ColorOut_CallOut11, Output_CallOut22);

	// Function call #23
    float3 Output_CallOut23;
    MultiplyFloat3(Diffuse_CallOut21, Output_CallOut14, Output_CallOut23);
	...
	// Function call #25
    CompositeFinalRGBAColor(OutputColor_CallOut24, Output_CallOut17, Out.Color);
