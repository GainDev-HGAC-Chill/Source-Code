#line 2 "C:\Program Files\Emergent\Gamebryo 2.2 Evaluation\Sdk\Win32\Shaders\Data\DX9\\Generated\\NiStandardMaterial\00000B8F-00000000-10000000-002C0012-P.hlsl"
//---------------------------------------------------------------------------
// Constant variables:
//---------------------------------------------------------------------------
...
Output Main(Input In)
{
    ...
    TextureRGBSample(ParallaxOffsetUV_CallOut6, Detail, bool(false), 
        ColorOut_CallOut8);
	...
	// Function call #10
    float3 Color_CallOut10;
    float Opacity_CallOut10;
    SplitColorAndOpacity(ColorOut_CallOut7, Color_CallOut10, Opacity_CallOut10);

	// Function call #11
    float3 Output_CallOut11;
    ScaleFloat3(ColorOut_CallOut8, float(2.0), Output_CallOut11);

	// Function call #12
    float3 WorldNormalOut_CallOut12;
    CalculateNormalFromColor(ColorOut_CallOut9, VectorOut_CallOut0, 
        VectorOut_CallOut3, VectorOut_CallOut1, int(0), 
        WorldNormalOut_CallOut12);

	// Function call #13
    float3 Output_CallOut13;
    MultiplyFloat3(Color_CallOut10, Output_CallOut11, Output_CallOut13);

	// Function call #14
    float Output_CallOut14;
    MultiplyFloat(Opacity_CallOut2, Opacity_CallOut10, Output_CallOut14);

	// Function call #15
    float3 AmbientAccumOut_CallOut15;
    float3 DiffuseAccumOut_CallOut15;
    float3 SpecularAccumOut_CallOut15;
    Light(In.WorldPos, WorldNormalOut_CallOut12, int(1), bool(false), 
        ...
        float3(0.0, 0.0, 0.0), AmbientAccumOut_CallOut15, 
    ...
    Light(In.WorldPos, WorldNormalOut_CallOut12, int(0), bool(false), 
        ...
        float4(1.0, 1.0, 1.0, 1.0), AmbientAccumOut_CallOut15, 
        DiffuseAccumOut_CallOut15, float3(0.0, 0.0, 0.0), 
    ...
    Light(In.WorldPos, WorldNormalOut_CallOut12, int(2), bool(false), 
    ...
    Light(In.WorldPos, WorldNormalOut_CallOut12, int(2), bool(false), 
        ...
        AmbientAccumOut_CallOut17, DiffuseAccumOut_CallOut17, 
        float3(0.0, 0.0, 0.0), AmbientAccumOut_CallOut18, 
    ...
    MultiplyFloat3(Diffuse_CallOut19, Output_CallOut13, Output_CallOut20);

	// Function call #21
    float3 OutputColor_CallOut21;
    CompositeFinalRGBColor(Output_CallOut20, Specular_CallOut19, 
        OutputColor_CallOut21);

	// Function call #22
    CompositeFinalRGBAColor(OutputColor_CallOut21, Output_CallOut14, Out.Color);
