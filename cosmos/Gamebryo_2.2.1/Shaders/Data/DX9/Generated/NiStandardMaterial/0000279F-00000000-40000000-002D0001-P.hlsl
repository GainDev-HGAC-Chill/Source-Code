#line 2 "C:\Program Files\Emergent\Gamebryo 2.2 Evaluation\Sdk\Win32\Shaders\Data\DX9\\Generated\\NiStandardMaterial\0000279F-00000000-40000000-002D0001-P.hlsl"
//---------------------------------------------------------------------------
// Constant variables:
//---------------------------------------------------------------------------
...
Output Main(Input In)
{
    ...
    Light(In.WorldPos, WorldNormalOut_CallOut12, int(1), bool(true), float(1.0), 
        VectorOut_CallOut5, g_PointWorldPosition, g_PointAmbient, 
    ...
    Light(In.WorldPos, WorldNormalOut_CallOut12, int(1), bool(true), float(1.0), 
        VectorOut_CallOut5, g_PointWorldPosition2, g_PointAmbient2, 
    ...
    Light(In.WorldPos, WorldNormalOut_CallOut12, int(1), bool(true), float(1.0), 
        VectorOut_CallOut5, g_PointWorldPosition3, g_PointAmbient3, 
    ...
    MultiplyFloat3(Specular_CallOut21, ColorOut_CallOut9, Output_CallOut22);
	...
	// Function call #25
    CompositeFinalRGBAColor(OutputColor_CallOut24, Output_CallOut15, Out.Color);
