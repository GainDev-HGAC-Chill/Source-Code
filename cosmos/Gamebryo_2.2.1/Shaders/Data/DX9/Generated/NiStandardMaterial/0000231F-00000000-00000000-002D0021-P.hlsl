#line 2 "C:\Program Files\Emergent\Gamebryo 2.2 Evaluation\Sdk\Win32\Shaders\Data\DX9\\Generated\\NiStandardMaterial\0000231F-00000000-00000000-002D0021-P.hlsl"
//---------------------------------------------------------------------------
// Constant variables:
//---------------------------------------------------------------------------
...
Output Main(Input In)
{
    ...
    Light(In.WorldPos, WorldNormalOut_CallOut9, int(0), bool(true), float(1.0), 
        VectorOut_CallOut7, g_DirWorldPosition0, g_DirAmbient0, g_DirDiffuse0, 
        g_DirSpecular0, float3(0.0, 1.0, 0.0), float3(-1.0, -1.0, 0.0), 
        g_DirWorldDirection0, g_MaterialPower, g_AmbientLight, 
        float3(0.0, 0.0, 0.0), float3(0.0, 0.0, 0.0), AmbientAccumOut_CallOut10, 
    ...
    Light(In.WorldPos, WorldNormalOut_CallOut9, int(0), bool(true), float(1.0), 
        VectorOut_CallOut7, g_DirWorldPosition, g_DirAmbient, g_DirDiffuse, 
        g_DirSpecular, float3(0.0, 1.0, 0.0), float3(-1.0, -1.0, 0.0), 
        g_DirWorldDirection, g_MaterialPower, AmbientAccumOut_CallOut10, 
        DiffuseAccumOut_CallOut10, SpecularAccumOut_CallOut10, 
    ...
    ComputeShadingCoefficients(g_MaterialEmissive, Color_CallOut2, 
        In.VertexColors, g_MaterialSpecular, SpecularAccumOut_CallOut13, 
    ...
    MultiplyFloat3(Specular_CallOut14, ColorOut_CallOut6, Output_CallOut15);

	// Function call #16
    float3 Output_CallOut16;
    MultiplyFloat3(Diffuse_CallOut14, Color_CallOut8, Output_CallOut16);

	// Function call #17
    float3 OutputColor_CallOut17;
    CompositeFinalRGBColor(Output_CallOut16, Output_CallOut15, 
