#line 2 "C:\Program Files\Emergent\Gamebryo 2.2 Evaluation\Sdk\Win32\Shaders\Data\DX9\\Generated\\NiStandardMaterial\00000B8F-01000000-10000000-002C0001-P.hlsl"
//---------------------------------------------------------------------------
// Constant variables:
//---------------------------------------------------------------------------
...
Output Main(Input In)
{
    ...
    float Opacity_CallOut11;
    SplitColorAndOpacity(ColorOut_CallOut9, Color_CallOut11, Opacity_CallOut11);

	// Function call #12
    float3 Output_CallOut12;
    MultiplyFloat3(Color_CallOut11, Output_CallOut7, Output_CallOut12);

	// Function call #13
    float3 WorldNormalOut_CallOut13;
    ...
    MultiplyFloat(Opacity_CallOut2, Opacity_CallOut11, Output_CallOut15);

	// Function call #16
    float3 AmbientAccumOut_CallOut16;
    float3 DiffuseAccumOut_CallOut16;
    float3 SpecularAccumOut_CallOut16;
    Light(In.WorldPos, WorldNormalOut_CallOut13, int(2), bool(false), 
    ...
    MultiplyFloat3(Diffuse_CallOut17, Output_CallOut12, Output_CallOut18);
	...
	// Function call #20
    CompositeFinalRGBAColor(OutputColor_CallOut19, Output_CallOut15, Out.Color);
