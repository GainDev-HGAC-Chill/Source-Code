#line 2 "C:\Program Files\Emergent\Gamebryo 2.2 Evaluation\Sdk\Win32\Shaders\Data\DX9\\Generated\\NiStandardMaterial\0000279F-11101000-10000000-002D0011-P.hlsl"
//---------------------------------------------------------------------------
// Constant variables:
//---------------------------------------------------------------------------
...
Output Main(Input In)
{
    ...
    MultiplyFloat(Opacity_CallOut4, Opacity_CallOut7, Output_CallOut8);

	// Function call #9
    float3 ColorOut_CallOut9;
    TextureRGBSample(In.UVSet1, Parallax, bool(false), ColorOut_CallOut9);

	// Function call #10
    float2 ParallaxOffsetUV_CallOut10;
    CalculateParallaxOffset(In.UVSet1, ColorOut_CallOut9, g_ParallaxOffset, 
        VectorOut_CallOut2, ParallaxOffsetUV_CallOut10);

	// Function call #11
    float3 ColorOut_CallOut11;
    TextureRGBSample(ParallaxOffsetUV_CallOut10, Dark, bool(false), 
        ColorOut_CallOut11);
    ...
    MultiplyFloat3(ColorOut_CallOut11, Color_CallOut7, Output_CallOut14);
    ...
    MultiplyFloat3(Specular_CallOut19, ColorOut_CallOut12, Output_CallOut20);
	...
	// Function call #23
    CompositeFinalRGBAColor(OutputColor_CallOut22, Output_CallOut8, Out.Color);
