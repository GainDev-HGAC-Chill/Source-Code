#line 2 "C:\Program Files\Emergent\Gamebryo 2.2 Evaluation\Sdk\Win32\Shaders\Data\DX9\\Generated\\NiStandardMaterial\0000030F-00000000-20000000-002C0013-P.hlsl"
//---------------------------------------------------------------------------
// Constant variables:
//---------------------------------------------------------------------------
...
Output Main(Input In)
{
    ...
    SplitColorAndOpacity(In.VertexColors, Color_CallOut5, Opacity_CallOut5);
	...
	// Function call #7
    float3 WorldNormalOut_CallOut7;
    CalculateNormalFromColor(ColorOut_CallOut3, VectorOut_CallOut0, 
        VectorOut_CallOut2, VectorOut_CallOut1, int(0), WorldNormalOut_CallOut7);

	// Function call #8
    float3 AmbientAccumOut_CallOut8;
    float3 DiffuseAccumOut_CallOut8;
    float3 SpecularAccumOut_CallOut8;
    Light(In.WorldPos, WorldNormalOut_CallOut7, int(1), bool(false), float(1.0), 
    ...
    MultiplyFloat(Opacity_CallOut5, Opacity_CallOut6, Output_CallOut9);
    ...
    Light(In.WorldPos, WorldNormalOut_CallOut7, int(0), bool(false), float(1.0), 
    ...
    Light(In.WorldPos, WorldNormalOut_CallOut7, int(2), bool(false), float(1.0), 
    ...
    Light(In.WorldPos, WorldNormalOut_CallOut7, int(2), bool(false), float(1.0), 
        float3(0.0, 0.0, 0.0), g_SpotWorldPosition2, g_SpotAmbient2, 
    ...
    MultiplyFloat3(Diffuse_CallOut15, Color_CallOut6, Output_CallOut16);

	// Function call #17
    float3 OutputColor_CallOut17;
    CompositeFinalRGBColor(Output_CallOut16, Specular_CallOut15, 
        OutputColor_CallOut17);

	// Function call #18
    CompositeFinalRGBAColor(OutputColor_CallOut17, Output_CallOut9, Out.Color);
