#line 2 "C:\Program Files\Emergent\Gamebryo 2.2 Evaluation\Sdk\Win32\Shaders\Data\DX9\\Generated\\NiStandardMaterial\00002789-00000800-00000000-000D0000-P.hlsl"
//---------------------------------------------------------------------------
// Constant variables:
//---------------------------------------------------------------------------
...
Output Main(Input In)
{
    ...
    TextureRGBSample(ParallaxOffsetUV_CallOut6, Dark, bool(false), 
        ColorOut_CallOut7);

	// Function call #8
    float3 ColorOut_CallOut8;
    TextureRGBSample(ParallaxOffsetUV_CallOut6, Gloss, bool(false), 
        ColorOut_CallOut8);

	// Function call #9
    float3 Output_CallOut9;
    MultiplyFloat3(In.SpecularAccum, ColorOut_CallOut8, Output_CallOut9);
    ...
    SplitColorAndOpacity(ColorOut_CallOut11, Color_CallOut13, Opacity_CallOut13);

	// Function call #14
    float Output_CallOut14;
    MultiplyFloat(Opacity_CallOut2, Opacity_CallOut13, Output_CallOut14);

	// Function call #15
    float3 Output_CallOut15;
    MultiplyFloat3(ColorOut_CallOut7, Color_CallOut13, Output_CallOut15);

	// Function call #16
    float3 Output_CallOut16;
    MultiplyFloat3(Color_CallOut2, Output_CallOut15, Output_CallOut16);

	// Function call #17
    float3 OutputColor_CallOut17;
    CompositeFinalRGBColor(Output_CallOut16, Output_CallOut9, 
        OutputColor_CallOut17);

	// Function call #18
    CompositeFinalRGBAColor(OutputColor_CallOut17, Output_CallOut14, Out.Color);
