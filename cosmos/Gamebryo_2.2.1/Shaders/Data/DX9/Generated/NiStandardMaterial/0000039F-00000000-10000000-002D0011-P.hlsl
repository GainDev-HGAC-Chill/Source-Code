#line 2 "C:\Program Files\Emergent\Gamebryo 2.2 Evaluation\Sdk\Win32\Shaders\Data\DX9\\Generated\\NiStandardMaterial\0000039F-00000000-10000000-002D0011-P.hlsl"
//---------------------------------------------------------------------------
// Constant variables:
//---------------------------------------------------------------------------
...
Output Main(Input In)
{
    ...
    SplitColorAndOpacity(ColorOut_CallOut8, Color_CallOut10, Opacity_CallOut10);
    ...
    MultiplyFloat(Opacity_CallOut4, Opacity_CallOut10, Output_CallOut13);
    ...
    Light(In.WorldPos, WorldNormalOut_CallOut11, int(2), bool(true), float(1.0), 
        ...
        AmbientAccumOut_CallOut14, DiffuseAccumOut_CallOut14, 
        SpecularAccumOut_CallOut14, AmbientAccumOut_CallOut15, 
    ...
    MultiplyFloat3(Diffuse_CallOut16, Color_CallOut10, Output_CallOut17);
	...
	// Function call #19
    CompositeFinalRGBAColor(OutputColor_CallOut18, Output_CallOut13, Out.Color);
