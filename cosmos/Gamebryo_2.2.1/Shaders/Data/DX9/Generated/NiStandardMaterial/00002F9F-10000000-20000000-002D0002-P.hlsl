#line 2 "C:\Program Files\Emergent\Gamebryo 2.2 Evaluation\Sdk\Win32\Shaders\Data\DX9\\Generated\\NiStandardMaterial\00002F9F-10000000-20000000-002D0002-P.hlsl"
//---------------------------------------------------------------------------
// Constant variables:
//---------------------------------------------------------------------------
...
Output Main(Input In)
{
	...
	// Function call #10
    float3 ColorOut_CallOut10;
    TextureRGBSample(ParallaxOffsetUV_CallOut9, Dark, bool(false), 
        ColorOut_CallOut10);
	...
	// Function call #16
    float3 Color_CallOut16;
    float Opacity_CallOut16;
    SplitColorAndOpacity(ColorOut_CallOut13, Color_CallOut16, Opacity_CallOut16);

	// Function call #17
    float Output_CallOut17;
    MultiplyFloat(Opacity_CallOut4, Opacity_CallOut16, Output_CallOut17);
    ...
    Light(In.WorldPos, WorldNormalOut_CallOut14, int(1), bool(true), float(1.0), 
        ...
        float3(-1.0, -1.0, 0.0), float3(1.0, 0.0, 0.0), g_MaterialPower, 
        AmbientAccumOut_CallOut15, DiffuseAccumOut_CallOut15, 
        SpecularAccumOut_CallOut15, AmbientAccumOut_CallOut18, 
        DiffuseAccumOut_CallOut18, SpecularAccumOut_CallOut18);

	// Function call #19
    float3 Output_CallOut19;
    MultiplyFloat3(ColorOut_CallOut10, Color_CallOut16, Output_CallOut19);

	// Function call #20
    float3 AmbientAccumOut_CallOut20;
    float3 DiffuseAccumOut_CallOut20;
    float3 SpecularAccumOut_CallOut20;
    Light(In.WorldPos, WorldNormalOut_CallOut14, int(2), bool(true), float(1.0), 
        ...
        SpecularAccumOut_CallOut18, AmbientAccumOut_CallOut20, 
        DiffuseAccumOut_CallOut20, SpecularAccumOut_CallOut20);

	// Function call #21
    float3 Output_CallOut21;
    MultiplyFloat3(Output_CallOut19, Output_CallOut7, Output_CallOut21);
    ...
    Light(In.WorldPos, WorldNormalOut_CallOut14, int(2), bool(true), float(1.0), 
        ...
        g_SpotWorldDirection, g_MaterialPower, AmbientAccumOut_CallOut20, 
        DiffuseAccumOut_CallOut20, SpecularAccumOut_CallOut20, 
        AmbientAccumOut_CallOut22, DiffuseAccumOut_CallOut22, 
        SpecularAccumOut_CallOut22);

	// Function call #23
    float3 Diffuse_CallOut23;
    float3 Specular_CallOut23;
    ComputeShadingCoefficients(g_MaterialEmissive, Color_CallOut4, 
        In.VertexColors, g_MaterialSpecular, SpecularAccumOut_CallOut22, 
        DiffuseAccumOut_CallOut22, AmbientAccumOut_CallOut22, bool(false), 
        Diffuse_CallOut23, Specular_CallOut23);

	// Function call #24
    float3 Output_CallOut24;
    MultiplyFloat3(Specular_CallOut23, ColorOut_CallOut11, Output_CallOut24);

	// Function call #25
    float3 Output_CallOut25;
    MultiplyFloat3(Diffuse_CallOut23, Output_CallOut21, Output_CallOut25);

	// Function call #26
    float3 OutputColor_CallOut26;
    CompositeFinalRGBColor(Output_CallOut25, Output_CallOut24, 
        OutputColor_CallOut26);

	// Function call #27
    CompositeFinalRGBAColor(OutputColor_CallOut26, Output_CallOut17, Out.Color);
