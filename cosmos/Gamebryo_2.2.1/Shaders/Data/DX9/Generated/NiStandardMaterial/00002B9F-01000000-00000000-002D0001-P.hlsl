#line 2 "C:\Program Files\Emergent\Gamebryo 2.2 Evaluation\Sdk\Win32\Shaders\Data\DX9\\Generated\\NiStandardMaterial\00002B9F-01000000-00000000-002D0001-P.hlsl"
//---------------------------------------------------------------------------
// Constant variables:
//---------------------------------------------------------------------------
...
Output Main(Input In)
{
    ...
    ComputeShadingCoefficients(g_MaterialEmissive, Color_CallOut4, 
        In.VertexColors, g_MaterialSpecular, SpecularAccumOut_CallOut16, 
        DiffuseAccumOut_CallOut16, AmbientAccumOut_CallOut16, bool(false), 
        Diffuse_CallOut18, Specular_CallOut18);

	// Function call #19
    float3 Output_CallOut19;
    MultiplyFloat3(Specular_CallOut18, ColorOut_CallOut11, Output_CallOut19);

	// Function call #20
    float3 Output_CallOut20;
    MultiplyFloat3(Diffuse_CallOut18, Output_CallOut14, Output_CallOut20);
	...
	// Function call #22
    CompositeFinalRGBAColor(OutputColor_CallOut21, Output_CallOut17, Out.Color);
