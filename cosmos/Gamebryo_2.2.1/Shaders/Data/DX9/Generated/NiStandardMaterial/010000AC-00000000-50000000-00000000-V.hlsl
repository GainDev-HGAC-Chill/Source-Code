#line 2 "C:\Program Files\Emergent\Gamebryo 2.2 Evaluation\Sdk\Win32\Shaders\Data\DX9\\Generated\\NiStandardMaterial\010000AC-00000000-50000000-00000000-V.hlsl"
//---------------------------------------------------------------------------
// Constant variables:
//---------------------------------------------------------------------------
...
Output Main(Input In)
{
	...
	// Function call #3
    float3 WorldViewVector_CallOut3;
    CalculateViewVector(Out.WorldPos, g_EyePos, WorldViewVector_CallOut3);

	// Function call #4
    WorldToTangent(WorldViewVector_CallOut3, Out.WorldNormal, Out.WorldBinormal, 
