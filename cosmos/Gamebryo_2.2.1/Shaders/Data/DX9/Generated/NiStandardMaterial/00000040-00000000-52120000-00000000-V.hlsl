#line 2 "C:\Program Files\Emergent\Gamebryo 2.2 Evaluation\Sdk\Win32\Shaders\Data\DX9\\Generated\\NiStandardMaterial\00000040-00000000-52120000-00000000-V.hlsl"
//---------------------------------------------------------------------------
// Constant variables:
//---------------------------------------------------------------------------
...
Output Main(Input In)
{
    ...
    Light(WorldPos_CallOut0, VectorOut_CallOut3, int(2), bool(false), 
        ...
        AmbientAccumOut_CallOut6, DiffuseAccumOut_CallOut6, 
        float3(0.0, 0.0, 0.0), AmbientAccumOut_CallOut7, 
