#line 2 "C:\Program Files\Emergent\Gamebryo 2.2 Evaluation\Sdk\Win32\Shaders\Data\DX9\\Generated\\NiStandardMaterial\0000030F-00000000-10000000-002C0012-P.hlsl"
//---------------------------------------------------------------------------
// Constant variables:
//---------------------------------------------------------------------------
...
Output Main(Input In)
{
    ...
    MultiplyFloat3(Diffuse_CallOut13, Color_CallOut6, Output_CallOut14);

	// Function call #15
    float3 OutputColor_CallOut15;
    CompositeFinalRGBColor(Output_CallOut14, Specular_CallOut13, 
        OutputColor_CallOut15);

	// Function call #16
    CompositeFinalRGBAColor(OutputColor_CallOut15, Output_CallOut9, Out.Color);
