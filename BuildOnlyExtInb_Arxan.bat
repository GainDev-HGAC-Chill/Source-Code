...
SET LOGFILE="BuildOnlyExtInb_Arxan.log"
SET SOURCE_EXE="..\Dragonica_Exe\SFreedom_Dev\Release\DragonSaga_INB.exe"
SET SOURCE_MAP="..\Dragonica_Exe\SFreedom_Dev\Release\DragonSaga_INB.map"
SET SOURCE_PDB="..\Dragonica_Exe\SFreedom_Dev\Release\DragonSaga_INB.pdb"
SET SOURCE_ZIP="..\Dragonica_Exe\SFreedom_Dev\Release\DragonSaga_INB.zip"
...
%MSDEV% /rebuild Dragonica_INB_America .\Freedom\MobileSuit\Freedom.sln >> %LOGFILE%
