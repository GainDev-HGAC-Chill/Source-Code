...
SET BATCHNAME="BuildOnly"
SET SVN="C:\Program Files\Subversion\bin\svn.exe"
SET MSDEV="C:\Program Files\Microsoft Visual Studio 8\Common7\IDE\devenv.com"
SET LOGFILE="BuildOnly.log"
SET SOURCE_EXE="..\Dragonica_Exe\SFreedom_Dev\Release\Dragonica_Internal.exe"
SET SOURCE_MAP="..\Dragonica_Exe\SFreedom_Dev\Release\Dragonica_Internal.map"
SET SOURCE_PDB="..\Dragonica_Exe\SFreedom_Dev\Release\Dragonica_Internal.pdb"
SET SOURCE_ZIP="..\Dragonica_Exe\SFreedom_Dev\Release\Dragonica_Internal.zip"
SET SOURCE_DEBUG_EXE="..\Dragonica_Exe\SFreedom_Dev\Debug\Dragonica.exe"
