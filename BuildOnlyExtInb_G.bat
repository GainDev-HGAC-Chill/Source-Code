...
SET LOGFILE="BuildOnlyExtInb_G.log"
SET SOURCE_EXE="..\Dragonica_Exe\SFreedom_Dev\Release\Dragonica_INB_G.exe"
SET SOURCE_MAP="..\Dragonica_Exe\SFreedom_Dev\Release\Dragonica_INB_G.map"
SET SOURCE_PDB="..\Dragonica_Exe\SFreedom_Dev\Release\Dragonica_INB_G.pdb"
SET SOURCE_ZIP="..\Dragonica_Exe\SFreedom_Dev\Release\Dragonica_INB_G.zip"
...
%MSDEV% /rebuild Dragonica_INB_G .\Freedom\MobileSuit\Freedom.sln >> %LOGFILE%
